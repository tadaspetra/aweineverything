...
import SeriesAndGate from './_components/SeriesAndGate.tsx';

In college, I decided to study Computer Engineering, solely because I could not understand how you can turn electricity into everything we use computers for. How does the same thing that turns on a light bulb:
...
To begin understanding computers, let's look at some of the first computers ever made, because even those are incredible.

## Boolean

Everything started when George Boole tried to mathematize **logic**, which at that point was a branch of philosophy.
...
![Boole's Book](./_assets/booles-book.png)
...
![[Pasted image 20251120083133.png]]
...
![[Pasted image 20251120130336.png]]
...
![[Pasted image 20251120141331.png]]
